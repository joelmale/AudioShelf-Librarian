              ...
              <details className="v2-settings-group" open>
                ...
                <div className="v2-settings-grid">
                  ...
                  <div className="v2-folder-patterns">
                    ...
                    <p className="v2-settings-note">Supported tokens: <code>{"{author}"}</code>, <code>{"{title}"}</code>, <code>{"{series}"}</code>, <code>{"{series_number}"}</code>, <code>{"{year}"}</code>, and <code>{"{narrator}"}</code>. Literal braces can wrap a token, for example <code>{"{year} - {title} - {{{narrator}}}"}</code>. Wrap a part in <code>[ ]</code> to make it optional: <code>{"{author}/{series}/[{series_number} - ]{title}"}</code> keeps a book whose series number is unset, filing it without the number instead of skipping it.</p>

...
export function ProcessPage({ mode }: { mode: "scan" | "review" }) {
  ...
  return <div className="v2-page v2-legacy-surface">
    ...
    {mode === "scan" && <ScannerControl onScanStarted={setPlanOnlySession}/>}<ProgressTracker/><ScanResultsReview planOnly={planOnlySession} onPlanOnlyDetected={setPlanOnlySession}/>
  </div>;
}
